...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 backdrop-blur-xl bg-white/80 border-b border-border shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 md:px-12">
        ...
        <Link
          href="/contact"
          className="hidden md:block text-[13px] font-semibold px-6 py-2.5 bg-accent text-white rounded-full tracking-wide shadow-button transition-all duration-300 hover:bg-accent-dark hover:shadow-button-hover hover:-translate-y-0.5"
        >
          Book a Call
        </Link>
